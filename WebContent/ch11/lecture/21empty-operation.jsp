...
pageContext.setAttribute("pageAttr2", new int[0]);
...
%>
	...
	\${empty pageAttr1} 빈 문자열 : ${empty pageAttr1} <br>
	\${empty pageAttr2} 길이가 0인 배열 : ${empty pageAttr2} <br>
	\${empty pageAttr3} 빈 Collection : ${empty pageAttr3} <br>
	\${empty pageAttr4} 빈 Map : ${empty pageAttr4} <br>
	
	<h1>not empty 연산자</h1>
	\${not empty attr1} null : ${not empty attr1} <br>
	\${not empty pageAttr1} 빈 문자열 : ${not empty pageAttr1} <br>
	\${not empty pageAttr2} 길이가 0인 배열 : ${not empty pageAttr2} <br>
	\${not empty pageAttr3} 빈 Collection : ${not empty pageAttr3} <br>
	\${not empty pageAttr4} 빈 Map : ${not empty pageAttr4} <br>
